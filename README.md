...
This is a frontend personal portafolio website, based in the Windows 95 style, built to showcase my projects, skills, and contact information. The project uses a React-based UI and in the future I am planning to add more features.
...
## Pages Information
1. **Welcome Page**: Introduction to the portafolio with direct access to all of the other pages/tabs.
...
- **Animated Cloud Background**: The background behind the Welcome Page is a group of clouds animated modified from this github repository [here](https://github.com/akashleo/react-cloud-animation). I decided to build the Cloud background again because the component imported from npm didnt work for my project.
...
- **React-Draggable**: For making the pages draggable accross the screen.
