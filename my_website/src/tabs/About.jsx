        ...
        <>
            <div className="font-['W95font'] select-none relative z-50">
                ...
                <WindowFrame title="About Me" iconSrc={aboutIcon} windowClassName="w-[92vw] sm:w-[50rem]  sm:h-[38rem] h-[80vh]" frameclassName="p-6" onClose={onClose}>
                    ...
                    {/* Header */}
                    <div className="flex flex-row  justify-center items-center text-center gap-3 mb-6">
                        <img className="w-24 h-24 sm:w-36 sm:h-36 object-cover border-[3px] border-black dark:border-white [image-rendering:pixelated]" src={me} alt="avatar" draggable={false}/>
                        <div>
