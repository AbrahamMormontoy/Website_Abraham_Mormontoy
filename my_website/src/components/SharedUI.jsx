...
export function TitleBar({ title, iconSrc, showExit = true }) {
  return (
...
export function WindowFrame({ title, iconSrc, showExit, children, footer ,windowClassName , frameclassName="" }) {
    return (
        <div className={`m-auto w-full p-1 bg-[#c0c0c0] dark:bg-[#333333] shadow-[inset_-1.5px_-1.5px_0px_0px_#000000] flex flex-col ${windowClassName}`}>
            <TitleBar title={title} iconSrc={iconSrc} showExit={showExit} />
